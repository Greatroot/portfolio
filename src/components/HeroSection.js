                ...
                <div className="container">
                    ...
                    <div className="hero__social">
                        ...
                        <div className="hero__social__text">
                            <ul>
                                <li>
                                    <a href="https://www.facebook.com/ben.kosa.52"
                                       target="_blank"
                                       rel="noreferrer"
                                    >
                                        FB
                                ...
                                <li>
                                    <a href="https://www.instagram.com/bkosa2/"
                                       target="_blank"
                                       rel="noreferrer"
                                    >
                                        IG
                                ...
                                <li>
                                    <a href="https://www.linkedin.com/in/ben-kosa-2b04251ab/"
                                       target="_blank"
                                       rel="noreferrer"
                                    >
                                        LI
                                ...
                                <li>
                                    <a href="https://github.com/Greatroot"
                                       target="_blank"
                                       rel="noreferrer"
                                    >
                                        GH
